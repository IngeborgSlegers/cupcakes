...
// PROMPT: add another attribute that tracks how many the shop has sold over time (cupcakesSold). Where do we add the counter? Do we need a whole new method? Or can we modify one that already exists? Try it with a constructor function.
